...
public class seleniumLambdaAcceotanceTestsApplication {
    ...
    static String Geckodriver = "C:/Users/juann/Desktop/serverless/apps microservicios serverless/aws-lambda-migration-microservice-app/lambda selenium tests/driver/geckodriver.exe";
    static String PathFirefox = "C:\\Program Files\\Firefox Developer Edition\\firefox.exe";
    static WebDriver driver = getDriver(PathFirefox, Geckodriver);
    static String URL = "http://spa-microservices-app.s3-website.eu-central-1.amazonaws.com/";
    ...
    public void PR03() {
        ...
        result = PO_View.checkElementBy(driver, "id", "1-delete");
        result.get(0).click();
